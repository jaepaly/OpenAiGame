...
export type SignalTraceStatus = "inactive" | "active" | "won" | "lost";

export interface SignalTraceState {
...
export type SolarEngineStatus = "inactive" | "active" | "won" | "lost";

export interface SolarEngineState {
  status: SolarEngineStatus;
  charge: number;
  chargeTarget: number;
  heat: number;
  heatLimit: number;
