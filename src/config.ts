...
export const RANKS: RankDefinition[] = [
  ...
  {
    code: "RAN", icon: "🌧", color: "#69b7e8", fuelDrain: 1.32, valueMultiplier: 1.12, routeId: "tailwind", identity: "RAIN BELT · LONG COMBO",
    name: "지역 하늘지사",
    altitude: "상공 2,000m",
    promotionCost: 90,
    requiredHarvest: 12,
  ...
  {
    code: "ELC", icon: "⚡", color: "#b695ff", fuelDrain: 1.72, valueMultiplier: 1.3, routeId: "pressureMine", identity: "CHARGED MINE · DENSE VALUE",
    name: "전국 기상기업",
    altitude: "상공 5,500m",
    promotionCost: 800,
    requiredHarvest: 55,
    weights: { cumulus: 0.27, rain: 0.45, electric: 0.28, ice: 0, solar: 0, aurora: 0 },
    description: "위험하고 짜릿한 전기구름이 나타납니다.",
  },
  {
    code: "ICE", icon: "❄", color: "#9eeeff", fuelDrain: 2.18, valueMultiplier: 1.55, routeId: "pressureMine", identity: "STRATOSPHERE · HARD CRYSTAL",
    name: "성층권 수확본부",
    altitude: "상공 15,000m",
    promotionCost: 4800,
    requiredHarvest: 600,
    weights: { cumulus: 0.1, rain: 0.26, electric: 0.39, ice: 0.25, solar: 0, aurora: 0 },
    description: "차갑고 단단한 빙정구름이 나타나는 성층권 항로를 개척합니다.",
  },
  {
    code: "SOL", icon: "☀", color: "#ffd15e", fuelDrain: 2.72, valueMultiplier: 1.9, routeId: "frontline", identity: "JET STREAM · SOLAR RUSH",
    name: "제트기류 산업연합",
    altitude: "상공 30,000m",
    promotionCost: 22000,
    requiredHarvest: 1200,
    weights: { cumulus: 0.05, rain: 0.15, electric: 0.29, ice: 0.29, solar: 0.22, aurora: 0 },
    description: "빛나는 태양구름과 초고속 제트기류를 산업화합니다.",
  },
  {
    code: "AUR", icon: "✦", color: "#7ff5df", fuelDrain: 3.35, valueMultiplier: 2.35, routeId: "frontline", identity: "IONOSPHERE · SPECTRUM JACKPOT",
    name: "전리층 기상공단",
    altitude: "상공 60,000m",
    promotionCost: 90000,
    requiredHarvest: 1800,
    weights: { cumulus: 0.02, rain: 0.07, electric: 0.16, ice: 0.24, solar: 0.29, aurora: 0.22 },
...
export const RUN_SKILLS: Record<RunSkillId, RunSkillDefinition> = {
  ...
  cargoCyclone: { id: "cargoCyclone", name: "연료 사이클론", description: "피버 중 연료 소모가 38% 감소하고 최소 구름 재고가 대폭 확장됩니다.", icon: "F-C", color: "#a8ffbe", maxStacks: 1, category: "synergy", requirements: ["sunStorm", "nanoSwarm"] },
  ...
  ecoThrusters: { id: "ecoThrusters", name: "순환 추진기", description: "이동에 드는 연료가 35% 감소합니다.", icon: "ECO", color: "#ffbd78", maxStacks: 1, category: "core", requirements: ["aeroDrive"] },
  vacuumRecycler: { id: "vacuumRecycler", name: "진공 회수관", description: "흡입에 드는 연료가 35% 감소합니다.", icon: "REC", color: "#ffc985", maxStacks: 1, category: "core", requirements: ["ecoThrusters"] },
  fuelCondenser: { id: "fuelCondenser", name: "연료 응축기", description: "직접 수확한 구름이 1.5칸 연료 셀을 만들기 시작합니다. 기본 회수 한도는 비행당 8칸입니다.", icon: "CEL", color: "#ffe07b", maxStacks: 1, category: "evolution", requirements: ["vacuumRecycler"] },
  comboGenerator: { id: "comboGenerator", name: "콤보 발전기", description: "직접 수확 콤보가 길수록 연료 셀이 더 자주 발생하며 6콤보마다 확정 충전됩니다.", icon: "GEN", color: "#ffe879", maxStacks: 1, category: "core", requirements: ["fuelCondenser"] },
  recoveryReservoir: { id: "recoveryReservoir", name: "회수 저장조", description: "최대 연료 +6, 비행당 연료 회수 한도 +14를 얻습니다.", icon: "RSV", color: "#fff08a", maxStacks: 1, category: "overdrive", requirements: ["comboGenerator"] },
  stormFuel: { id: "stormFuel", name: "폭풍 연료핵", description: "전기 이상 구름의 연료 셀이 5칸을 충전하고 회수 한도가 40 증가합니다.", icon: "ION", color: "#fff7a8", maxStacks: 1, category: "evolution", requirements: ["recoveryReservoir"] },
};
...
export const INITIAL_STATE = {
  ...
  story: { seen: [] as StorySceneId[], rivalBeaten: false, electricSignalCleared: false, iceArchiveRecovered: false, solarEngineDisabled: false, skyRestored: false },
  career: {
