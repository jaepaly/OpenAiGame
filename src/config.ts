...
export const RANKS: RankDefinition[] = [
  ...
  {
    code: "ELC", icon: "⚡", color: "#b695ff", fuelDrain: 1.6, valueMultiplier: 1.3, routeId: "pressureMine", identity: "CHARGED MINE · DENSE VALUE",
    name: "전국 기상기업",
    altitude: "상공 5,500m",
    promotionCost: 650,
    requiredHarvest: 45,
  ...
  {
    code: "ICE", icon: "❄", color: "#9eeeff", fuelDrain: 2, valueMultiplier: 1.55, routeId: "pressureMine", identity: "STRATOSPHERE · HARD CRYSTAL",
    name: "성층권 수확본부",
    altitude: "상공 15,000m",
    promotionCost: 2800,
    requiredHarvest: 90,
  ...
  {
    code: "SOL", icon: "☀", color: "#ffd15e", fuelDrain: 2.45, valueMultiplier: 1.9, routeId: "frontline", identity: "JET STREAM · SOLAR RUSH",
    name: "제트기류 산업연합",
    altitude: "상공 30,000m",
    promotionCost: 11500,
    requiredHarvest: 180,
  ...
  {
    code: "AUR", icon: "✦", color: "#7ff5df", fuelDrain: 3, valueMultiplier: 2.35, routeId: "frontline", identity: "IONOSPHERE · SPECTRUM JACKPOT",
    name: "전리층 기상공단",
    altitude: "상공 60,000m",
    promotionCost: 48000,
    requiredHarvest: 360,
